...
<context>
    ...
    <message>
        ...
        <translation>暗号方式は、データベースの暗号化に使用される暗号化アルゴリズムを決定します。</translation>
    </message>
    <message>
        <location filename="../dbsqlitemc.cpp" line="61"/>
        <source>Cipher configuration (optional)</source>
        <translation>暗号方式の設定（任意）</translation>
    </message>
    <message>
...
See documentation for SQLite3 Multiple Ciphers for details.</source>
        <translation>KDF の反復回数、レガシーモードなど、SQLite3 Multiple Ciphers の設定をカスタマイズするための PRAGMA 文です。
これらはデータベースを開くたびに実行されます。
詳細については、SQLite3 Multiple Ciphers のドキュメントを参照してください。</translation>
    </message>
</context>
</TS>
