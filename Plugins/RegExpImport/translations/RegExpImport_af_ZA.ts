...
<context>
    ...
    <message>
        ...
        <translation>&lt;p&gt;Versoekte vasleggingsgroepnaam &apos;%1&apos;, maar dit is nie in die patroon gedefinieer nie: &lt;pre&gt;%2&lt;/pre&gt;&lt;/p&gt;</translation>
    </message>
</context>
<context>
...
&lt;p&gt;If you used named groups in the pattern, you can use names instead of indexes. You can mix indexes and names in this list.&lt;/p&gt;</source>
        <translation>&lt;p&gt;Voer ’n kommageskeide lys van vasleggingsgroepindekse in. Die 0-indeks verwys na die hele ooreenstemmende string.&lt;/p&gt;
&lt;p&gt;As jy benoemde groepe in die patroon gebruik het, kan jy name in plaas van indekse gebruik. Jy kan indekse en name in hierdie lys meng.&lt;/p&gt;</translation>
    </message>
    <message>
...
You can use named groups and refer to them in group list below. To name a group use: &lt;pre&gt;(?&amp;lt;myGroupName&amp;gt;\s+\d+\s+)&lt;/pre&gt;&lt;/p&gt;</source>
        <translation>&lt;p&gt;Gebruik reguliere-uitdrukking-groepe om dele van die uitdrukking wat jy wil invoer, te omsluit. As jy &apos;n groep wil gebruik wat jy nie wil invoer nie, gebruik dan die &quot;voer slegs die volgende groepe in&quot;-opsie hieronder.

Jy kan benoemde groepe gebruik en daarna in die groeplys hieronder verwys. Om &apos;n groep te benoem, gebruik: &lt;pre&gt;(?&amp;lt;myGroupName&amp;gt;\s+\d+\s+)&lt;/pre&gt;&lt;/p&gt;</translation>
    </message>
    <message>
